...
public class MSTTSSpeech
{
	...
	public static void main(String[] args)
	{
		...
		String text="我们的使命与愿景成为世界级最专业、最具创新性的销售管理服务商";
		speech.setFormatType(6);
		// speech.setRate(-1);
		speech.saveToWav(text,"C:\\Users\\FreeGuardian\\Desktop\\voice\\test\\test1.wav");
		//speech.speak(text);
//		SoundUtil.wavToPcm("C:\\Users\\FreeGuardian\\Desktop\\voice\\test\\test1.pcm");
	}
}